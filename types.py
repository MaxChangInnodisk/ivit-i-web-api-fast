...
class DeviceNotSupport(Exception):

    def __init__(self, message):
        self.message = message

class ModelNotSupport(Exception):
    def __init__(self, message):
        self.message = message
...
class ThresholdIncorrect(Exception):
    def __init__(self, message):
        self.message = message

class LinePointIncorrect(Exception):
    def __init__(self, error):
        self.error = error
    def __str__(self) :
        print(self.error)
        error_str =""
        for error_info in self.error:
            area_name , line_name_list = error_info
            error_str = error_str + area_name+":"
            
            for line_name in line_name_list:
                error_str = error_str +line_name+" , "
        error_str = error_str + "is out of area point."
        return error_str
