...
from .db_handler import parse_app_data, select_data
from .ivit_handler import iAPP_CLS, iAPP_HANDLER, iAPP_OBJ, iAPP_SEG
...
def create_app(app_uid: str, label_path: str) -> Union[iAPP_CLS, iAPP_OBJ, iAPP_SEG]:
    ...
    log.info(f"Creating application ( {task_name}: {task_uid})")
    ...
    log.info(f"Initialized application: {app_uid}")
    return app
